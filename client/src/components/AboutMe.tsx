          ...
          <HeroHighlight>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <p className="leading-relaxed">I believe that software engineering is not just about writing code; it's about creating solutions that impact people's lives. Whether it's optimizing an algorithm or designing an intuitive user interface, I'm committed to making a positive difference.</p>
                <p className="leading-relaxed">Prior to entering the tech world, I worked 5 years in hospitality and 2 years in construction, both jobs require good communication skills and being a team player, these are traits I can bring to the work place.</p>
              </div>
            </motion.h1>
          </HeroHighlight>
        </div>
